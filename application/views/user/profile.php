...
<main id="main">
    <section id="" class="contact">
        <div class="container py-5">
            ...
            <div class="row mt-5">
              <div class="col-lg-12">
                  <form action="<?= site_url('main/viewEditProfile') ?>" method="POST">
                      <div class="row">
                          <div class="col-md-6 form-group">
                              <label for="name">Name:</label>
                              <input disabled type="text" id="name" name="Cnama" class="form-control" value="<?= $user['Cnama'] ?>">
                          </div>
                          <div class="col-md-6 form-group mt-3 mt-md-0">
                              <label for="email">Email:</label>
                              <input disabled type="email" id="email" name="Cemail" class="form-control" value="<?= $user['Cemail'] ?>">
                          </div>
                      </div>
                      <div class="form-group mt-3">
                          <label for="phone">Phone:</label>
                          <input disabled type="text" id="phone" name="Ctlpn" class="form-control" value="<?= $user['Ctlpn'] ?>">
                      </div>
                      <div class="form-group mt-3">
                          <label for="password">Password:</label>
                          <input disabled type="password" id="password" name="Cpassword" class="form-control" value="<?= $user['Cpassword'] ?>">
                      </div>
